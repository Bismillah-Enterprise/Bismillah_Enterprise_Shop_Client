...
const SelfTransections = () => {
    ...
    return (
        <div className='relative'>
            ...
            <h1 className='text-pink-300 text-lg lg:text-2xl text-center font-semibold'>Abdul Kader Transections</h1>
            ...
            <div className='mt-10 flex flex-col lg:flex-row items-center justify-center gap-5'>
                <Link to={`/admin/self_revenue_transections_details`} state={{ pathname: location.pathname }} className="text-center text-pink-200 cursor-pointer shadow-md hover:shadow-lg shadow-pink-300 px-3 lg:px-5 py-1 rounded-md text-md lg:text-lg lg:font-semibold">
                    Current Month All Revenue Transections
                </Link>
                <Link to={`/admin/self_expense_transections_details`} state={{ pathname: location.pathname }} className="text-center text-pink-200 cursor-pointer shadow-md hover:shadow-lg shadow-pink-300 px-3 lg:px-5 py-1 rounded-md text-md lg:text-lg lg:font-semibold">
            ...
            <div className='mt-10 flex flex-col lg:flex-row items-center justify-center gap-5'>
                ...
                <Link to={`/admin/self_transections_summary`} state={{ pathname: location.pathname }} className="text-center text-pink-200 cursor-pointer shadow-md hover:shadow-lg shadow-pink-300 px-3 lg:px-5 py-1 rounded-md text-md lg:text-lg lg:font-semibold">
                    Self Monthly Transections Summary
                </Link>
            </div>
...
export default SelfTransections;