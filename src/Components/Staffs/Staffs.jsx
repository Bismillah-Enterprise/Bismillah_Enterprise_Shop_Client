							...
							<tr>
								...
								<td id="enter1_time">
									<div className='flex items-center justify-between gap-0'>
										...
										<MdEdit onClick={() => { handleEditTime('today_enter1_time') }} className={`text-end cursor-pointer ${user_category === 'admin' ? 'block' : 'hidden'}`} />
									</div>
								</td>
								<td id="exit1_time">
									<div className='flex items-center justify-between gap-0'>
										...
										<MdEdit onClick={() => { handleEditTime('today_exit1_time') }} className={`text-end cursor-pointer ${user_category === 'admin' ? 'block' : 'hidden'}`} />
									</div>
								</td>
								<td id="enter2_time">
									<div className='flex items-center justify-between gap-0'>
										...
										<MdEdit onClick={() => { handleEditTime('today_enter2_time') }} className={`text-end cursor-pointer ${user_category === 'admin' ? 'block' : 'hidden'}`} />
									</div>
								</td>
								<td id="exit2_time">
									<div className='flex items-center justify-between gap-0'>
										...
										<MdEdit onClick={() => { handleEditTime('today_exit2_time') }} className={`text-end cursor-pointer ${user_category === 'admin' ? 'block' : 'hidden'}`} />
									</div>
								</td>
							</tr>
						</tbody>
